...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
    ...
    // removing headers
    requestState.removeHeadersFromResponse.forEach((name) => {
...
function getHandler(options, proxy) {
    var corsAnywhere = {
        ...
        removeHeadersFromResponse: [], // Strip headers from response (a little more than cors).
    ...
    return function (req, res) {
        req.corsAnywhereRequestState = {
            ...
            removeHeadersFromResponse: corsAnywhere.removeHeadersFromResponse,
        };
